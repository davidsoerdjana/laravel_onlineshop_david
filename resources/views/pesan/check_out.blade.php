                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="centre">Rp. {{ number_format($pesanan_detail->barang->harga) }}</td>
                                <td align="centre">Rp. {{ number_format($pesanan_detail->jumlah_harga) }}</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td align="centre"><strong>Rp. {{ number_format($pesanan->jumlah_harga) }}</strong></td>
                                <td>
